  ...
  return (
    <div className="flex flex-col w-full h-full">
      <header className="flex h-20 w-full flex-row justify-around items-center bg-white border-b-[1px] border-gray-300">
        ...
        <div className="font-thin text-lg">Ultimate Blog App</div>
        <div className="flex items-center space-x-4">
          ...
          <div>
            <button className="flex transition hover:border-gray-900 hover:text-gray-900 items-center px-4 py-2 space-x-3 border border-gray-200 rounded">
              <div>
                Write
              </div>
              <div>
